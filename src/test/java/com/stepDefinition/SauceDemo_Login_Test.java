...
public class SauceDemo_Login_Test {
	...
	public void user_enters_the_user_name_as() throws Throwable {
		sauceDemo_page.enter_username_special_chars();
	}

	@When("^User enters the user name as onetwothreefour$")
	public void user_enters_the_user_name_as1() throws Throwable {
		sauceDemo_page.enter_username_numericals();
	}

	@When("^User enters the user name as #@onetwothreefour")
	public void user_enters_the_user_name_as_onetwothreefour() throws Throwable {
